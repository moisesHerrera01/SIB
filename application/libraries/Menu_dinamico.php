    ...
    if (is_array($user) && !empty($user)){
      $html_out = "<nav>";
        $html_out .= "<ul class='hbp-vimenu'>";
          $html_out .= "<li>";
            $html_out .= "<span>SIB INSAFOCOOP</span>";
          $html_out .= "</li>";
          $html_out .= "<li>";
          ...
          $html_out .= "</li>";
          $html_out .= "<li>";
            $html_out .= "<a id='help' class='icono icon-question'></a>";
          $html_out .= "</li>";
          $html_out .= "<li>";
            $html_out .= "<a href=".base_url("index.php/login/logout")." class='icono icon-switch'></a>";
          $html_out .= "</li>";
        $html_out .= "</ul>";
      $html_out .= "</nav>";

      $html_out .= "<div class='tgs'></div>";
      $html_out .= "<div class='container-area-notice'>";
      $html_out .= "<div class='title-area'>Notificaciones</div>";
        $html_out .= "<div class='content-area-notice'>";
        $html_out .= "</div>";
      $html_out .= "</div>";

      $html_out .= "<div class='tgsh'></div>";
      $html_out .= "<div class='container-area-help'>";
        $html_out .= "<div class='title-area'>Ayuda</div>";
        $html_out .= "<div class='content-area-help'>";
          $html_out .= "<div id='bug' class='content-box-help'><span class='cont-icon-help icon-bug'></span><span class='cont-txt-help'>Reportar un problema</span></div>";
        $html_out .= "</div>";
      $html_out .= "</div>";
