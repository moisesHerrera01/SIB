...
class Solicitud_retiro extends CI_Controller {
  ...
  public function __construct() {
    ...
    $this->load->model(array('Bodega/Solicitud_retiro_model','Bodega/Detalle_solicitud_producto_model', 'Bodega/Fuentefondos_model'));
  }
  ...
  */
  ...
  public function Liquidar(){
    ...
    if($estado=='APROBADA'){
      $this->notificacion->NotificacionSolicitudBodega($id, $USER, 4);
