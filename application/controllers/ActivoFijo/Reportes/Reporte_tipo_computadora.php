...
class Reporte_tipo_computadora extends CI_Controller {
  ...
  public function Reporte() {
    ...
    if($USER){
      ...
      $data['js'] = 'assets/js/validate/reporte/activofijo/tipo_com.js';
      $table = '';
      ...
      if ($this->uri->segment(5) != '' && $this->uri->segment(6) != '' && $this->uri->segment(7) != '') {
        ...
        $total = $this->Equipo_informatico_model->totalEquipoPorTipoComputadoraLimit($this->uri->segment(5), $this->uri->segment(6), $this->uri->segment(7));
