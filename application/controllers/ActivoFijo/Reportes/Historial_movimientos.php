  ...
  public function mostrarTabla(){
    ...
    */
    ...
    if ($this->input->is_ajax_request()) {
          ...
          $pagination = paginacion('index.php/ActivoFijo/Reportes/Historial_movimientos/index/'.$this->uri->segment(5), $this->Movimiento_Model->totalMovimientosDetalle($this->uri->segment(5)),
                        $num, '6');
    } else {
          $registros = $this->Movimiento_Model->obtenerMovimientosLimitId($num, $this->uri->segment(6),$this->uri->segment(5));
          $pagination = paginacion('index.php/ActivoFijo/Reportes/Historial_movimientos/index/'.$this->uri->segment(5), $this->Movimiento_Model->totalMovimientosDetalle($this->uri->segment(5)),
