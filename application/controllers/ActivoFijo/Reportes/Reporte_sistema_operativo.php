...
class Reporte_sistema_operativo extends CI_Controller {
  ...
  public function __construct() {
    ...
    $this->load->model(array('ActivoFijo/Sistema_operativo_model','ActivoFijo/Equipo_informatico_model'));
  }
  ...
  public function RecibirDatos() {
    ...
    if($USER){
      if ($this->input->post('version')!=NULL && $this->input->post('fechaMin')!=NULL && $this->input->post('fechaMax')!=NULL) {
        ...
        } elseif ($this->input->post('version')==NULL && $this->input->post('fechaMin')!=NULL && $this->input->post('fechaMax')!=NULL) {
          redirect('ActivoFijo/Reportes/Reporte_sistema_operativo/Reporte/todo'.'/'.$this->input->post('fechaMin') . '/' .$this->input->post('fechaMax'));
        } else{
  ...
  public function Reporte() {
    ...
    if($USER){
      ...
      $data['js'] = 'assets/js/validate/reporte/activofijo/sist_op.js';
      $table = '';
      ...
      if ($this->uri->segment(5) != '' && $this->uri->segment(6) != '' && $this->uri->segment(7) != '') {
        ...
        $total = $this->Sistema_operativo_model->totalObtenerEquipoPorOSLimit($this->uri->segment(5), $this->uri->segment(6), $this->uri->segment(7));
