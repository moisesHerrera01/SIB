...
class Solicitud_movimiento extends CI_Controller {
  ...
  public function index(){
    if($this->session->userdata('logged_in')){
      ...
      $data['js'] = "assets/js/validate/sol_mov.js";
      ...
      */
      ...
      if ($this->input->is_ajax_request()) {
        if (!($this->input->post('busca') == "")) {
            ...
            $pagination = paginacion('index.php/ActivoFijo/Solicitud_movimiento/index/', $this->Movimiento_Model->totalMovimientos($USER['id_seccion'])->total,$num, '4');
        }
      } else {
            $registros = $this->Movimiento_Model->obtenerSolMovimientosLimit($num, $this->uri->segment(4),$USER['id_seccion']);
            $pagination = paginacion('index.php/ActivoFijo/Solicitud_movimiento/index/', $this->Movimiento_Model->totalMovimientos($USER['id_seccion'])->total,$num, '4');
