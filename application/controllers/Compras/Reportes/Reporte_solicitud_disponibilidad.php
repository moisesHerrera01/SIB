    ...
    if($USER){
      ...
      if ($this->uri->segment(5)!=NULL) {
        ...
        $table =  "<div class='content_table '>" .
                  ...
                  Exportar Excel</a>&nbsp;
                  <a href='".base_url('/index.php/Compras/Reportes/Reporte_solicitud_disponibilidad/ImprimirReporte/'.$this->uri->segment(5).'/'.$this->uri->segment(6).'/'.
    ...
    if ($USER) {
      if ($this->uri->segment(5) != NULL) {
        ...
        $data = array(
          ...
          'param' => "CUADRO DE REPORTE DE SOLICITUDES DE DISPONIBILIDAD FINANCIERA".' DEL '.$fecha_inicio.' AL '.$fecha_fin
        );
