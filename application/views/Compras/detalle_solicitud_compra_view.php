...
$USER = $this->session->userdata('logged_in');
  ...
  $bandera = 0;
if($modulo=='Compras/Solicitud_Compra/Detalle_Solicitud_Compra' && $nivel<2 || $modulo=='Compras/Aprobar_Solicitud/Detalle_Solicitud_Compra' && ($nivel==2 || $nivel==1 || $nivel==3) &&
 ($autorizante == 111 || $USER['rol'] == 'COLABORADOR BODEGA' || $USER['rol'] == 'JEFE BODEGA' || $USER['rol'] == 'JEFE UNIDAD' ||
  ...
  || $modulo=='Compras/Gestionar_Solicitud/Detalle_Solicitud_Compra' && ($nivel==3||$nivel==4) && $USER['rol'] == 'JEFE COMPRAS' || $USER['rol'] == 'COLABORADOR COMPRAS' ||
  $USER['rol'] == 'JEFE UACI'|| $USER['rol'] == 'COLABORADOR UACI' || $USER['rol'] == 'ADMINISTRADOR SICBAF'){
    if ($modulo=='Compras/Solicitud_Compra/Detalle_Solicitud_Compra'){
      if ($nivel == 0 || $nivel == 1){
        $bandera = 1;
      }
    }
    ...
    if ($modulo == 'Compras/Gestionar_Solicitud/Detalle_Solicitud_Compra'){
      if ($nivel == 3 || $nivel == 4){
        $bandera = 1;
      }
    }
