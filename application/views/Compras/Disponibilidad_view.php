  ...
  <body onload="window.print()">
    <div class="content">
      <div>
        ...
        <p align="right">
          <?php
            echo "San Salvador, " . fecha($datos[0]->fecha_ingreso);
          ?>
        </p>
      </div>
      <p>Se&ntilde;ores</p>
      ...
      <table border="1" width="100%">
        ...
        <?php
          ...
          if($data->precio_estimado==0){
            ...
            echo "<tr>";
            echo "<td align=center>". $data->numero_solicitud_compra ."</td>";
      ...
      <table border="1" width="100%">
        ...
        <?php if ($data->fecha=='0000-00-00'): ?>
          <tr>
            <td colspan=4>
              <p>Confirmación de asignación prespuestaria No. <?= $data->numero_solicitud_compra?> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
