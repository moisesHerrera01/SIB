<?php
  ...
  echo form_open("/ActivoFijo/Aprobar_movimiento_autorizante_autorizante/ActualizarDatos", $atributos);
...
echo "</div>";
  $buscar = array(
    ...
    'autocomplete' => 'off',
    'id' => 'buscar',
    'url' => 'index.php/ActivoFijo/Aprobar_movimiento_autorizante/mostrarTabla'
  );
