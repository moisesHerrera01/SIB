<?php
  ...
  echo "<div class='content-form'>";
    ...
    echo "<div class='limit-content'>";
      echo form_open("/ActivoFijo/Detalle_aprobar_movimiento_autorizante/RecibirDatos", $atributos);
  ...
  $buscar = array(
    ...
    'autocomplete' => 'off',
    'id' => 'buscar',
    'url' => 'index.php/ActivoFijo/Detalle_aprobar_movimiento_autorizante/mostrarTabla/'.$nombre
  );
