    ...
    if (isset($controller)) {
      switch ($controller) {
        ...
        case 'Productos':
          switch ($alert) {
            case 'asociado':
              $mensaje = "Este producto esta asociado a especifico(s).";
              $tipo='warning';
              break;
            default:
              break;
            ...
            case 'Gestionar_Solicitud':
              switch ($alert) {
                case 'descargado':
                  ...
                  break;
                case 'nonumero':
                  $mensaje = "NO APROBADA: El número de requerimiento aún no ha sido asignado.";
                  $tipo = 'warning';
                  break;
                    break;
                default:
          ...
          case 'Solicitud_Disponibilidad':
            switch ($alert) {
              case 'dependencia':
                $mensaje = "La solicitud de disponibilidad tiene asociados montos.";
                $tipo = 'warning';
                break;
              case 'nomonto':
                $mensaje = "NO CONFIRMADA: No se han asignado montos a la solicitud.";
                $tipo = 'warning';
                break;
            }
            break;
        ...
        case 'Orden_compra':
          switch ($alert) {
            case 'noresumen':
              $mensaje = "NO CONFIRMADA: No ha ingresado productos en el detalle resumen, por favor ingreselos a las OC implicadas en el requerimiento.";
              $tipo='warning';
              break;
            default:
              break;
