<?php
  class Producto extends CI_Model{
    ...
    public function buscarProductos($busca){
      $this->db->select("a.id_producto, a.nombre, a.id_unidad_medida, u.nombre nombre_unidad, a.descripcion, a.estado,
       a.fecha_caducidad, a.stock_minimo, a.exento,a.generico");
    ...
    public function estaAsociado($id_producto){
      $this->db->select('')
