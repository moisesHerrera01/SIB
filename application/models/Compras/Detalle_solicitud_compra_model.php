...
/*Obtine el listado completo de productos para el detalle del requerimiento de compra*/
      public function obtenerEspecificosProductosCompras(){
        $this->db->select('p.generico as nombre,e.id_especifico,dp.id_detalleproducto, u.nombre nombre_unidad')
                 ->from('sic_producto p')
...
o nombre del producto*/
      ...
      public function validarAutorizante($id_solicitud_compra,$id_empleado){
        $this->db->select('*')
                 ->from('sic_solicitud_compra')
                 ->where('autorizante',$id_empleado)
